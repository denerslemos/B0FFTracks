...
TH1D* mHistALambdaSSMC  = new TH1D("mHistALambdaSSMC","#bar{#Lambda} invariant mass;M(GeV);counts",400,1.0,1.2); mHistLambdaSSMC->Sumw2(); 
TH1D* mHistALambdaOSMC  = new TH1D("mHistALambdaOSMC","#bar{#Lambda} invariant mass;M(GeV);counts",400,1.0,1.2); mHistLambdaOSMC->Sumw2(); 
